...
public class C {
    ...
    public final static String DB_PATH = "/data/data/com.rytass.geeyang.servicedemo/";
    public final static String DATABASE_NAME = "servicedemo.db";
    public final static String APP_PATH = "/servicedemo/";
